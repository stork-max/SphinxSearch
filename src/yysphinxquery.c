...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_value_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, XQParser_t * pParser)
#else
static void
...
`--------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_symbol_print (FILE *yyoutput, int yytype, YYSTYPE const * const yyvaluep, XQParser_t * pParser)
#else
static void
...
`------------------------------------------------*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yy_reduce_print (YYSTYPE *yyvsp, int yyrule, XQParser_t * pParser)
#else
static void
...
/*ARGSUSED*/
     ...
     || defined __cplusplus || defined _MSC_VER)
static void
yydestruct (const char *yymsg, int yytype, YYSTYPE *yyvaluep, XQParser_t * pParser)
#else
static void
...
yyreduce:
  ...
  switch (yyn)
    ...
    { pParser->AddQuery ( (yyvsp[(1) - (1)].pNode) ); ;}
    break;
  ...
  case 4:
    ...
    { (yyval.pNode) = pParser->AddOp ( SPH_QUERY_AND, (yyvsp[(1) - (2)].pNode), (yyvsp[(2) - (2)].pNode) ); ;}
    break;

  case 6:

    { pParser->SetFieldSpec ( (yyvsp[(1) - (1)].tFieldLimit).dMask, (yyvsp[(1) - (1)].tFieldLimit).iMaxPos ); ;}
    break;

  case 7:

    { pParser->SetZoneVec ( (yyvsp[(1) - (1)].iZoneVec) ); ;}
    break;

  case 8:

    { pParser->SetZoneVec ( (yyvsp[(1) - (1)].iZoneVec), true ); ;}
    break;
  ...
  case 10:
    ...
    { (yyval.pNode) = pParser->AddOp ( SPH_QUERY_BEFORE, (yyvsp[(1) - (3)].pNode), (yyvsp[(3) - (3)].pNode) ); ;}
    break;

  case 11:

    { (yyval.pNode) = pParser->AddOp ( SPH_QUERY_NEAR, (yyvsp[(1) - (3)].pNode), (yyvsp[(3) - (3)].pNode), (yyvsp[(2) - (3)].tInt).iValue ); ;}
    break;
  ...
  case 13:
    ...
    { (yyval.pNode) = pParser->AddOp ( SPH_QUERY_NOT, (yyvsp[(3) - (3)].pNode), NULL ); ;}
    break;
  ...
  case 16:
    ...
    { (yyval.pNode) = pParser->AddOp ( SPH_QUERY_OR, (yyvsp[(1) - (4)].pNode), (yyvsp[(4) - (4)].pNode) ); ;}
    break;

  case 17:

    { (yyval.pNode) = pParser->AddOp ( SPH_QUERY_MAYBE, (yyvsp[(1) - (4)].pNode), (yyvsp[(4) - (4)].pNode) ); ;}
    break;
  ...
  case 25:
    ...
    { (yyval.pNode) = (yyvsp[(2) - (3)].pNode); pParser->SetPhrase ( (yyval.pNode), false ); ;}
    break;
  ...
  case 27:
    ...
    { (yyval.pNode) = (yyvsp[(2) - (5)].pNode); if ( (yyval.pNode) ) { assert ( (yyval.pNode)->m_dWords.GetLength() ); (yyval.pNode)->SetOp ( SPH_QUERY_QUORUM ); (yyval.pNode)->m_iOpArg = (yyvsp[(5) - (5)].tInt).iValue; } ;}
    break;

  case 28:

    { (yyval.pNode) = (yyvsp[(2) - (5)].pNode); if ( (yyval.pNode) ) { assert ( (yyval.pNode)->m_dWords.GetLength() ); (yyval.pNode)->SetOp ( SPH_QUERY_QUORUM ); (yyval.pNode)->m_iOpArg = (yyvsp[(5) - (5)].tInt).fValue * 100; (yyval.pNode)->m_bPercentOp = true; } ;}
    break;
  ...
  case 30:
    ...
    { (yyval.pNode) = (yyvsp[(3) - (4)].pNode); pParser->SetPhrase ( (yyval.pNode), true ); ;}
    break;
  ...
  case 32:
    ...
    { (yyval.pNode) = pParser->AddKeyword ( ( (yyvsp[(1) - (1)].tInt).iStrIndex>=0 ) ? pParser->m_dIntTokens[(yyvsp[(1) - (1)].tInt).iStrIndex].cstr() : NULL ); ;}
    break;
  ...
  case 34:
    ...
    { (yyval.pNode) = (yyvsp[(2) - (2)].pNode); assert ( (yyval.pNode)->m_dWords.GetLength()==1 ); if ( !((yyval.pNode)->m_dWords[0].m_sWord.IsEmpty()) ) (yyval.pNode)->m_dWords[0].m_sWord.SetSprintf ( "=%s", (yyval.pNode)->m_dWords[0].m_sWord.cstr() ); ;}
    break;

  case 35:

    { (yyval.pNode) = pParser->AddOp ( SPH_QUERY_SENTENCE, (yyvsp[(1) - (3)].pNode), (yyvsp[(3) - (3)].pNode) ); ;}
    break;
  ...
  case 37:
    ...
    { (yyval.pNode) = pParser->AddOp ( SPH_QUERY_PARAGRAPH, (yyvsp[(1) - (3)].pNode), (yyvsp[(3) - (3)].pNode) ); ;}
    break;
  ...
  case 40:
    ...
    { (yyval.pNode) = (yyvsp[(2) - (3)].pNode); if ( (yyval.pNode) ) { assert ( (yyval.pNode)->m_dWords.GetLength() ); (yyval.pNode)->SetOp ( SPH_QUERY_PHRASE); } ;}
    break;
  ...
  case 42:
    ...
    { (yyval.pNode) = pParser->AddKeyword ( (yyvsp[(1) - (2)].pNode), (yyvsp[(2) - (2)].pNode) ); ;}
    break;
